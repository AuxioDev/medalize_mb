...
/// their child. Also reused inline on `booking_calendar_screen.dart` (once a
/// slot is picked) so the choice can be made (or changed) right in the
/// booking flow itself, not only ahead of time from the home screen.
