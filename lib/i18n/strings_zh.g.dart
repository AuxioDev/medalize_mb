...
class _Translations$auth$zh extends Translations$auth$en {
	...
	@override String get joinMedalize => '立即加入 Medoro';
...
class _Translations$security$zh extends Translations$security$en {
	...
	@override String get biometricPrompt => '请验证身份以访问 Medoro';
...
class _Translations$legal$zh extends Translations$legal$en {
	...
	@override String get controllerNotice => 'Medoro 由 AuxioDev（auxiodev.com）在阿塞拜疆创建并运营（"我们"）。最后更新：2026年7月。';
	@override String get privacyTitle => '隐私政策';
	@override String get privacyIntro => '本政策说明 Medoro 收集哪些个人数据、原因以及如何保护这些数据。预约和管理医疗就诊必然涉及您的健康信息，下面将详细说明。';
	...
	@override String get termsBody => '提供关于您自己的准确信息。仅将 Medoro 用于查找、预约和管理医疗就诊。对您的登录凭证保密。Medoro 将您与独立的、持证的医疗专业人员联系起来——我们自身并非医疗机构，AI 症状检查助手也不能替代专业医疗诊断或建议。如遇医疗紧急情况，请直接联系急救服务，而非使用本应用。对于违反本条款或滥用平台的账号，我们可能会暂停或终止其使用。';
	...
	@override String get pdfDocumentTitle => 'Medoro — 隐私政策与服务条款';
...
class _Translations$subscription$zh extends Translations$subscription$en {
	...
	@override String get manageOnWeb => '请在 auxiodev.com 管理您的订阅';
...
class _Translations$legal$sections$children$zh extends Translations$legal$sections$children$en {
	...
	@override String get body => 'Medoro 账号面向成年人。如果您未满18岁，请让父母或监护人使用家庭成员档案功能代您创建和管理账号。';
}
...
extension on TranslationsZh {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'security.biometricPrompt' => '请验证身份以访问 Medoro',
			...
			'legal.title' => '隐私与条款',
			'legal.controllerNotice' => 'Medoro 由 AuxioDev（auxiodev.com）在阿塞拜疆创建并运营（"我们"）。最后更新：2026年7月。',
			'legal.privacyTitle' => '隐私政策',
			'legal.privacyIntro' => '本政策说明 Medoro 收集哪些个人数据、原因以及如何保护这些数据。预约和管理医疗就诊必然涉及您的健康信息，下面将详细说明。',
			...
			'legal.sections.children.body' => 'Medoro 账号面向成年人。如果您未满18岁，请让父母或监护人使用家庭成员档案功能代您创建和管理账号。',
			'legal.termsTitle' => '服务条款',
			'legal.termsIntro' => '创建账号即表示您同意以下内容。',
			'legal.termsBody' => '提供关于您自己的准确信息。仅将 Medoro 用于查找、预约和管理医疗就诊。对您的登录凭证保密。Medoro 将您与独立的、持证的医疗专业人员联系起来——我们自身并非医疗机构，AI 症状检查助手也不能替代专业医疗诊断或建议。如遇医疗紧急情况，请直接联系急救服务，而非使用本应用。对于违反本条款或滥用平台的账号，我们可能会暂停或终止其使用。',
			...
			'legal.pdfDocumentTitle' => 'Medoro — 隐私政策与服务条款',
			...
			'subscription.manageOnWeb' => '请在 auxiodev.com 管理您的订阅',
