...
class _Translations$auth$fr extends Translations$auth$en {
	...
	@override String get joinMedalize => 'Rejoignez DocGet dès aujourd\'hui';
...
class _Translations$security$fr extends Translations$security$en {
	...
	@override String get biometricPrompt => 'Authentifiez-vous pour accéder à DocGet';
...
class _Translations$home$fr extends Translations$home$en {
	...
	@override String quickBookWith({required Object name}) => 'Réserver avec ${name}';
}
...
class _Translations$legal$fr extends Translations$legal$en {
	...
	@override String get controllerNotice => 'DocGet est créé et exploité par AuxioDev (auxiodev.com), Azerbaïdjan (« nous »). Dernière mise à jour : juillet 2026.';
	@override String get privacyTitle => 'Politique de confidentialité';
	@override String get privacyIntro => 'Cette politique explique quelles données personnelles DocGet collecte, pourquoi, et comment elles sont protégées. La prise et la gestion de rendez-vous médicaux impliquent nécessairement des informations de santé vous concernant, détaillées ci-dessous.';
	...
	@override String get pdfDocumentTitle => 'DocGet — Politique de confidentialité et conditions d\'utilisation';
...
class _Translations$subscription$fr extends Translations$subscription$en {
	...
	@override String get manageOnWeb => 'Gérez votre abonnement sur auxiodev.com';
...
class _Translations$legal$sections$children$fr extends Translations$legal$sections$children$en {
	...
	@override String get body => 'Les comptes DocGet sont destinés aux adultes. Si vous avez moins de 18 ans, demandez à un parent ou tuteur de créer et de gérer un compte en votre nom via la fonctionnalité de profils familiaux.';
}
...
extension on TranslationsFr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'auth.joinMedalize' => 'Rejoignez DocGet dès aujourd\'hui',
			'auth.iAmA' => 'Je suis',
			'auth.passwordHint' => '••••••••',
			...
			'security.biometricPrompt' => 'Authentifiez-vous pour accéder à DocGet',
			...
			'home.quickBookWith' => ({required Object name}) => 'Réserver avec ${name}',
			...
			'legal.controllerNotice' => 'DocGet est créé et exploité par AuxioDev (auxiodev.com), Azerbaïdjan (« nous »). Dernière mise à jour : juillet 2026.',
			'legal.privacyTitle' => 'Politique de confidentialité',
			'legal.privacyIntro' => 'Cette politique explique quelles données personnelles DocGet collecte, pourquoi, et comment elles sont protégées. La prise et la gestion de rendez-vous médicaux impliquent nécessairement des informations de santé vous concernant, détaillées ci-dessous.',
			...
			'legal.sections.children.body' => 'Les comptes DocGet sont destinés aux adultes. Si vous avez moins de 18 ans, demandez à un parent ou tuteur de créer et de gérer un compte en votre nom via la fonctionnalité de profils familiaux.',
			'legal.termsTitle' => 'Conditions d\'utilisation',
			'legal.termsIntro' => 'En créant un compte, vous acceptez ce qui suit.',
			'legal.termsBody' => 'Fournir des informations exactes vous concernant. Utiliser DocGet uniquement pour trouver, réserver et gérer des rendez-vous médicaux. Garder vos identifiants de connexion confidentiels. DocGet vous met en relation avec des professionnels de santé indépendants et agréés — nous ne sommes pas nous-mêmes un prestataire de soins, et l\'assistant IA de vérification des symptômes ne remplace pas un diagnostic ou un avis médical professionnel. En cas d\'urgence médicale, contactez directement les services d\'urgence, pas cette application. Nous pouvons suspendre ou résilier les comptes qui enfreignent ces conditions ou qui font un usage abusif de la plateforme.',
			...
			'legal.pdfDocumentTitle' => 'DocGet — Politique de confidentialité et conditions d\'utilisation',
			...
			'subscription.manageOnWeb' => 'Gérez votre abonnement sur auxiodev.com',
