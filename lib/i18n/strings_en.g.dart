...
class Translations$auth$en {
	...
	/// en: 'Join DocGet today'
	String get joinMedalize => 'Join DocGet today';
...
class Translations$settings$en {
	...
	/// en: 'DocGet v1.0.0'
	String get version => 'DocGet v1.0.0';
...
class Translations$security$en {
	...
	/// en: 'Authenticate to access DocGet'
	String get biometricPrompt => 'Authenticate to access DocGet';
...
class Translations$home$en {
	...
	/// en: 'Book with $name'
	String quickBookWith({required Object name}) => 'Book with ${name}';
}
...
class Translations$legal$en {
	...
	/// en: 'DocGet is created and operated by AuxioDev (auxiodev.com), Azerbaijan ("we", "us"). Last updated: July 2026.'
	String get controllerNotice => 'DocGet is created and operated by AuxioDev (auxiodev.com), Azerbaijan ("we", "us"). Last updated: July 2026.';

	/// en: 'Privacy Policy'
	String get privacyTitle => 'Privacy Policy';

	/// en: 'This policy explains what personal data DocGet collects, why, and how it is protected. Booking and managing medical appointments necessarily involves health information about you, so we explain that in detail below.'
	String get privacyIntro => 'This policy explains what personal data DocGet collects, why, and how it is protected. Booking and managing medical appointments necessarily involves health information about you, so we explain that in detail below.';
	...
	/// en: 'DocGet — Privacy Policy & Terms of Service'
	String get pdfDocumentTitle => 'DocGet — Privacy Policy & Terms of Service';
...
class Translations$legal$sections$children$en {
	...
	/// en: 'DocGet accounts are intended for adults. If you are under 18, please have a parent or guardian create and manage an account on your behalf using the family/dependent profile feature.'
	String get body => 'DocGet accounts are intended for adults. If you are under 18, please have a parent or guardian create and manage an account on your behalf using the family/dependent profile feature.';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'auth.joinMedalize' => 'Join DocGet today',
			'auth.iAmA' => 'I am a',
			'auth.passwordHint' => '••••••••',
			...
			'security.biometricPrompt' => 'Authenticate to access DocGet',
			...
			'home.quickBookWith' => ({required Object name}) => 'Book with ${name}',
			...
			'legal.controllerNotice' => 'DocGet is created and operated by AuxioDev (auxiodev.com), Azerbaijan ("we", "us"). Last updated: July 2026.',
			'legal.privacyTitle' => 'Privacy Policy',
			'legal.privacyIntro' => 'This policy explains what personal data DocGet collects, why, and how it is protected. Booking and managing medical appointments necessarily involves health information about you, so we explain that in detail below.',
			...
			'legal.sections.children.body' => 'DocGet accounts are intended for adults. If you are under 18, please have a parent or guardian create and manage an account on your behalf using the family/dependent profile feature.',
			...
			'legal.pdfDocumentTitle' => 'DocGet — Privacy Policy & Terms of Service',
